This is a reference implementation for sublox1, a sub-variant of the Lox programming language used in the book [Crafting Interpreters](https://craftinginterpreters.com/) by Bob Nystrom.
